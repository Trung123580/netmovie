...
import { FaRankingStar, MdLocalMovies, RiGlobalLine, RiMovie2Line, FaFacebookSquare, FaGithubSquare, FaTwitterSquare, FaInstagramSquare } from "@/utils/icons"
...
export const category: menuCategory = [
  ...
  {
    id: "fb13a707-be8b-4060-8a56-1409e301eb69",
    name: "Phim Nhạc",
    path: "phim-nhac",
  },
]
...
const topMovies = [
  ...
  { id: uuid(), name: "Anime", path: "hoathinh" },
]
